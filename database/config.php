...
*/
$config['login_email'] = "biuro@avit.pl";
$config['login_pass'] = "#Brzegowa68!";
...
$config['images_locations'] = Array( 1 => 'Lista na gorze', 2 => 'Ikona / logo', 3 => 'Galeria', 4 => 'Zdjęcie w tle', 0 => 'Ukryte' ); // domyślna wartość: 1 => 'Lewa strona', 2 => 'Prawa strona', 3 => 'Galeria', 0 => 'Brak'
...
$config['pages_menus'] = Array( 1 => 'Nawigacja', 2 => 'Sklep', 0 => 'Ukryte' ); // domyślna wartość: Array( 1 => 'Menu górne', 0 => 'Ukryte' )
$config['pages_types'] = Array( 1 => 'Standardowa zakładka', 2 => 'Produkt' );
$config['orders_status'] = Array( 0 => 'Nowe', 1 => 'Wysłano paczkę' );
/*
...
$config['category'] = Array( 0 => 'Brak', 1 => 'Kategoria 1', 2 => 'Kategoria 2');
