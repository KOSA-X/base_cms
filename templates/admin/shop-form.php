...
if( isset( $_POST['sName'] ) ){
  ...
  if( isset( $_POST['sOptionList'] ) )
    header( 'Location: '.$config['admin_file'].'?p=shop&sOption=save' );
  elseif( isset( $_POST['sOptionAddNew'] ) )
    header( 'Location: '.$config['admin_file'].'?p=shop-form&sOption=save' );
  else
    header( 'Location: '.$config['admin_file'].'?p=shop-form&sOption=save&iPage='.$iPage );
  exit;
}
      ...
      <ul id="tab-content" class="forms full tabsContent">
        ...
        <li class="parent">
         <div class="form-item">
          ...
          <select name="iPageParent" id="iPageParent" size="15"><option value=""<?php if( !isset( $iPageParent ) || $iPageParent == 0 ) echo ' selected="selected"'; ?>><?php echo $lang['none']; ?></option><?php echo $oPage->listPagesSelectAdmin( $iPageParent, 2 ); ?></select>
            </div>
        </li>
       ...
       <li class="custom">
        ...
        <li>
         <div class="form-item">
          ...
          <input type="hidden" id="iTheme" name="iTheme" value="6" class="numeric" />
        ...
        <li>
         <div class="form-item">
              <label for="sDesc">Dodatkowy opis</label>
